...
export default function SettingsForm() {
  ...
  const fetchSettings = async () => {
    try {
      ...
      // Pastikan nilai tidak null/undefined agar input tetap controlled
      setFormData({
  ...
  if (isFetching) return <div className="p-10 text-center text-slate-500">Memuat pengaturan...</div>;
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
            ...
            <div>
                ...
                />
                <p className="text-xs text-slate-500 mt-1">Akan muncul di tab browser.</p>
            </div>
            <div>
                <label className="block text-sm font-semibold text-slate-700 mb-1">Deskripsi Global</label>
                <textarea 
                  rows="3" 
        ...
        <div className="space-y-4 bg-blue-50 p-4 rounded-xl border border-blue-100">
            ...
            <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                    Masukkan kode verifikasi saja (bukan tag HTML lengkap).
                </p>
            </div>
        </div>
