        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-3">
              <Link to="/" className="flex items-center gap-2 text-purple-700 group">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="hidden lg:block text-[10px] text-slate-500 font-medium tracking-wider">
            ...
            <div className="hidden md:flex items-center gap-5">
              ...
              <Link
                to="/login"
                className="ml-2 px-5 py-2 text-sm font-semibold text-purple-700 border border-purple-200 rounded-full hover:bg-purple-600 hover:text-white transition-all shadow-sm"
              >
                Masuk Admin
              </Link>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <div className="flex flex-col gap-4">
              {[
                ...
                <Link
                  ...
                  to={item.to}
                  onClick={() => setIsMenuOpen(false)}
                  className="text-base font-medium text-slate-700 hover:text-purple-700 py-2 border-b border-slate-50"
                >
                  {item.label}
                </Link>
              ))}
            ...
            <div className="mt-8">
              <Link
                to="/login"
                onClick={() => setIsMenuOpen(false)}
                className="block w-full text-center py-3 text-white bg-purple-600 rounded-lg font-bold hover:bg-purple-700 transition shadow-md"
              >
                Masuk Admin Area
              </Link>
            </div>
