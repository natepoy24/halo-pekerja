                ...
                <div className="max-w-7xl mx-auto px-4 py-12 md:py-20 grid md:grid-cols-2 gap-12 items-center">
                    <div className="order-2 md:order-1">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button onClick={() => window.open("https://wa.me/628139511409", "_blank")} className="bg-white text-slate-700 border border-slate-200 px-8 py-4 rounded-xl font-bold hover:bg-slate-50 transition flex justify-center items-center gap-2">
